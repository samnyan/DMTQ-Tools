...
public sealed class SongCsvSchema : CsvSchema<Song>
{
    ...
    [
        ...
        new CsvColumn<Song>("original_bga_yn",   6,  s => NormalizeYn(s.OriginalBgaYn),  (s, v) => s.OriginalBgaYn = v),
        new CsvColumn<Song>("loop_bga_yn",       7,  s => NormalizeYn(s.LoopBgaYn),      (s, v) => s.LoopBgaYn = v),
        ...
        new CsvColumn<Song>("free_yn",           17, s => NormalizeYn(s.FreeYn),         (s, v) => s.FreeYn = v),
        new CsvColumn<Song>("hidden_yn",         18, s => NormalizeYn(s.HiddenYn),       (s, v) => s.HiddenYn = v),
        new CsvColumn<Song>("open_yn",           19, s => NormalizeYn(s.OpenYn),         (s, v) => s.OpenYn = v),
