...
public sealed class SongCsvSchema : CsvSchema<Song>
{
    ...
    [
        ...
        new CsvColumn<Song>("song_id",           0,  s => s.Id,               (s, v) => IdProperty.SetValue(s, v)),
        new CsvColumn<Song>("item_id",           1,  s => s.ItemId,           (s, v) => s.ItemId = v),
        ...
        new CsvColumn<Song>("cost_game_point",   13, s => s.CostGamePoint,    (s, v) => s.CostGamePoint = v),
        new CsvColumn<Song>("cost_game_cash",    14, s => s.CostGameCash,     (s, v) => s.CostGameCash = v),
        new CsvColumn<Song>("flag",              15, s => s.Flag,             (s, v) => s.Flag = v),
        ...
        new CsvColumn<Song>("track_id",          20, s => s.TrackId,          (s, v) => s.TrackId = v),
